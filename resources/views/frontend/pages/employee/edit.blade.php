                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="designation" class="form-select"
                                            ...
                                            <option value="3" @if($employee->
                                                designation
                                                == 3) selected
                                                @endif>Expert Wordpress
                                                Developer
                                            </option>
                                            <option value="4" @if($employee->
                                                designation
                                                == 4) selected
                                                @endif>Shopify Expert
                                            </option>
                                            <option value="5" @if($employee->
                                                designation
                                                == 5) selected
                                                @endif>PHP & Laravel
                                                Expert
                                            </option>
                                            <option value="6" @if($employee->
                                                designation
                                                == 6) selected
                                                @endif>JavaScript Developer
                                            </option>
                                            <option value="7" @if($employee->
                                                designation
                                                == 7) selected
                                                @endif>Social Media Expert
                                            </option>
