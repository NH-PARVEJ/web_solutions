                                            ...
                                            <h2 class="table-avatar">
                                                <a href="" class="avatar">
                                                    ...
                                                    <a href="#">{{Auth::user()->image}}<span>
                                                            ...
                                                            @elseif(Auth::user()->designation == 4)
                                                            Shopify Expert
                                                            @elseif(Auth::user()->designation == 5)
                                                            PHP & Laravel Expert
                                                            @elseif(Auth::user()->designation == 6)
                                                            JavaScript Developer
                                                            @elseif(Auth::user()->designation == 7)
                        ...
                        <div class="modal-body">
                            <form class="row" action="{{route('leave.store')}}" method="POST">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <textarea name="reason" value="{{old('reason')}}" rows="4"
